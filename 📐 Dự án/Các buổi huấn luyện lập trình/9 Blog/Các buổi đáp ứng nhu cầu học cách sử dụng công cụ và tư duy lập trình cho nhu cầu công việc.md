...
Một số buổi có bài viết chi tiết:
 ...
 - [[Tự động nhập sự kiện vào lịch\|Cào dữ liệu web vào Google Calendar]]{ .md-button .md-button--primary } 
# Lộ trình
...
[[📐 Dự án/Các buổi huấn luyện lập trình/4 Thành phẩm/Kế hoạch/Kế hoạch|Kế hoạch tổ chức]]{ .md-button .md-button--primary }
