...
| Xử lý tính toán   |                      |                      |
![[Dữ liệu đến từ sự định lượng của con người chỉ sử dụng thống kê. Dữ liệu từ sự đo lường các đại lượng vật lý dùng cả các loại toán khác 2026-03-04 15.51.45.excalidraw]]
...
[[Nếu độ phân tán của dữ liệu là lớn, thì tính đại diện của các chỉ số tập trung là thấp]]
...
![The 7 Base SI Units (Clip) \| Physics - Basics - YouTube](https://youtu.be/O8oZFaaJTUc?si=NXVvChgEGOhrvuVj)
...
Định lý giới hạn trung tâm khiến cho phân bố chuẩn Trong khi [[Mô hình Gauss thường được dùng trong thực nghiệm vì nó có entropy cao nhất khi chỉ dựa vào μ và σ]]
...
- [[Chỉ theo đuổi một chỉ số là quá đơn giản]]. [[Sự đơn giản ép ta phải làm nó cực kỳ tốt]]
- [[Việc phân loại không quan trọng bằng việc chuẩn bị cho sự thay đổi cách phân loại]]
- [[Cứt bò cứt ngựa trong thời đại dữ liệu]]

Khái niệm:: [[Dữ liệu]], [[Mô hình]], [[Phân loại]], [[Khảo sát]]

Kết quả sẽ được dùng để xây dựng chính sách
![[Tất cả các khái niệm dùng để đo lường.excalidraw]]
...
![What makes statistics different than mathematics - YouTube](https://youtu.be/b0KPNL7_Y3U?si=-B4Rr2IVOns0XQbd) 
