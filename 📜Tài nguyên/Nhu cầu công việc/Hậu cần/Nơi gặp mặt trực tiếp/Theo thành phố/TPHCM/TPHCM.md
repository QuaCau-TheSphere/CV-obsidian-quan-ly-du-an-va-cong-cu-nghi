...
FROM "📜Tài nguyên/Nhu cầucầu công việc/Hậu cần/Nơi gặp mặt trực tiếp/Theo thành phố/TPHCMthành phố/TPHCMthành phố/TPHCMthành phố/TPHCM/Quán có phòng riêng ở TPHCM"
...
Table 
	...
	không-gian-tạo-cảm-hứng as "Không gian tạo cảm hứng", 
	có-loa-mic as "Có loa mic"
FROM "📜Tài nguyên/Nhu cầu công việc/Hậu cần/Nơi gặp mặt trực tiếp/Theo thành phố/TPHCMthành phố/TPHCMthành phố/TPHCMthành phố/TPHCM/Quán không có phòng riêng ở TPHCM"
Where file.name!=split(file.folder, "/")[3] and file.name!="Nhà Ân" and file.name!=this.file.name
sort "Hình thức" 
```
# Phòng họp riêng
...
Table 
	...
	không-gian-tạo-cảm-hứng as "Không gian tạo cảm hứng", 
	có-loa-mic as "Có loa mic"
FROM "📜Tài nguyên/Nhu cầu công việc/Hậu cần/Nơi gặp mặt trực tiếp/Theo thành phố/TPHCMthành phố/TPHCMthành phố/TPHCMthành phố/TPHCMthành phố/TPHCM/Phòng họp riêng ở TPHCM"
Where file.name!=split(file.folder, "/")[3] and file.name!="Nhà Ân" and file.name!=this.file.name
sort "Hình thức" 
```
